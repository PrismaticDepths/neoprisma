...
[ ] scripting: add a way to create ui elements \
[ ] scripting: add a way to capture screen \
[ ] scripting: add a way to send and receive http requests \
[ ] playback/recording: optionally move mouse only on click events \
